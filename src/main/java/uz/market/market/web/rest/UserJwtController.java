...
import uz.market.market.security.JwtTokenProvider;
import uz.market.market.web.rest.vm.LoginVM;
...
public class UserJwtController {
    ...
    public ResponseEntity login(@RequestBody LoginVM loginVM){
        ...
        String token = jwtTokenProvider.createToken(((User) user).getUserName(), user.getRoles());
